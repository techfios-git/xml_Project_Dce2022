...
public class ListCustomerTest {
	...
	public void userShouldBeAbleToAddCustomerFromListCustomer(String userName, String password, String fullName, String company,String email, String phone, String address, String city, String state,String zip,String country) throws InterruptedException {
		...
		listCustomerPage.clickOnAddCustomerButtonOnListCustomer();
		...
		dashboardPage.clickOnListCustomerMenuElement();
		Thread.sleep(2000);
		listCustomerPage.insertSearchBarListCustomer();
		listCustomerPage.validateInsertedNameOnSearchBarAndProfilePage();
